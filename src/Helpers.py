...
def generate_docking_stations_map(map_shape: Tuple[int ,int], docks_no: int, frame_size: int, docks_params=None) -> np.array:
    """
            ...
            if tst == 0:
                ...
                for _ in range(frame_size * map_shape[1]):
                    ...
                    if map[frame_size:, 0][ind] == 0:
                        map[frame_size:, 0][ind] = np.random.randint(10, 100)
                        written = True
    return map
